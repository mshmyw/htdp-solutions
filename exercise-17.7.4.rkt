...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname |Exercise 17.7.4|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
...
(= (evaluate-with-defs (make-fapplication 'f 3)  my-defs) 6)
(= (evaluate-with-defs (make-fapplication 'g 123)  my-defs) 4)
(= (evaluate-with-defs (make-fapplication 'h (make-mul 2 5))  my-defs) 15)
(evaluate-with-defs (make-fapplication 'j (make-mul 2 5))  my-defs) ;; should error