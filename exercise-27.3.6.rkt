...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname exercise-27.3.6) (read-case-sensitive #t) (teachpacks ((lib "draw.ss" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "draw.ss" "teachpack" "htdp")))))
