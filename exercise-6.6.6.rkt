...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname |Exercise 6.6.6|) (read-case-sensitive #t) (teachpacks ((lib "guess.ss" "teachpack" "htdp") (lib "master.ss" "teachpack" "htdp") (lib "draw.ss" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "guess.ss" "teachpack" "htdp") (lib "master.ss" "teachpack" "htdp") (lib "draw.ss" "teachpack" "htdp")))))
...
(define (draw-and-clear-circle circ)
  (and (draw-a-circle circ)
       (sleep-for-a-while 5)
       (clear-a-circle circ)))