...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname exercise-28.1.3) (read-case-sensitive #t) (teachpacks ((lib "draw.ss" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "draw.ss" "teachpack" "htdp")))))
;; a graph is list of
;; (list a b)
...
(time (test-n-times 10000 'A 'E Graph))