...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname |exercise 22.3.1|) (read-case-sensitive #t) (teachpacks ((lib "gui.ss" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "gui.ss" "teachpack" "htdp")))))
;; Model:
