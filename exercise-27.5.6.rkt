...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname exercise-27.5.6) (read-case-sensitive #t) (teachpacks ((lib "draw.ss" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "draw.ss" "teachpack" "htdp")))))
...
(triangulate (list (list 0  3  3 8)
                   (list 3  3 -2 3)
                   (list 0 -0  2 4)))
(triangulate (list (list 2 3 2 6 3)
                   (list 2 3 4 8 2)
                   (list 2 3 1 2 2)
                   (list 2 3 5 6 7)))
