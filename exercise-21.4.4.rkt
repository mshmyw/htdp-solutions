...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname |exercise 21.4.4|) (read-case-sensitive #t) (teachpacks ((lib "draw.ss" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "draw.ss" "teachpack" "htdp")))))
...
;; tests
(define my-losh (list (make-circle (make-posn 34 53) 20 'blue)
                      (make-rectangle (make-posn 76 86) 23 57 'red)))
(start 300 300)
(draw-losh my-losh)
(sleep-for-a-while 1)
(clear-losh my-losh)
(sleep-for-a-while 1)
(draw-losh (translate-losh my-losh 50))