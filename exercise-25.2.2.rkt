...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname |exercise 25.2.2|) (read-case-sensitive #t) (teachpacks ((lib "draw.ss" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "draw.ss" "teachpack" "htdp")))))
...
;; TESTS
(equal? (quick-sort (list 6 4 9 3 11 64)) (list 3 4 6 9 11 64))
